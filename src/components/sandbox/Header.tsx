...
export function Header({ theme, setTheme }: HeaderProps) {
  return (
    <header className={`px-4 py-4 flex items-center justify-between sticky top-0 z-40 border-b transition-all duration-300 ${
      theme === 'minimalist'
        ? 'bg-white border-gray-150 text-[#001B3D]'
        : theme === 'light'
      ...
      <div className="flex items-center gap-2.5 relative z-10">
        ...
        >
          {theme === 'light' ? (
            ...
            /* Minimalist icon - a minimalist slider or simple layouts indicator */
