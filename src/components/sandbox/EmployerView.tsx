...
export function EmployerView({
  ...
  const filteredShiftsList = shifts.filter(s => {
    ...
    if (shiftsSubTab === 'history') return s.status === 'completed';
    return true;
  });
  ...
  return (
    <>
      <div className="flex-1 overflow-y-auto pb-28 no-scrollbar relative z-10">
        ...
        {b2bTab === 'dashboard' && (
          <div className="p-4 space-y-4 text-left animate-fade-in">
            {/* Header Banner */}
            <div className={`p-4 rounded-3xl border transition-all ${theme === 'light' ? 'bg-[#001B3D] text-white border-transparent' : 'bg-gradient-to-br from-[#1c2541]/80 to-[#121829] border-white/5'}`}>
              <span className="text-[9px] uppercase tracking-wider bg-[#FF5722] text-white px-2 py-0.5 rounded font-black">
                Панель Моніторингу
              </span>
              <h2 className="text-lg font-black mt-2 leading-tight">Вітаємо, {userName}!</h2>
              <p className="text-[10px] text-gray-300 mt-1">{companyName} · {companyDetails}</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3.5">
              <div className={`p-4 rounded-2xl border transition-all backdrop-blur-[16px] ${theme === 'light' ? 'bg-white/85 border-[#E5E7EB] shadow-sm' : 'bg-[#1c2541]/45 border-white/10 shadow-md'}`}>
                <p className="text-[10px] uppercase font-black text-gray-450 tracking-wider">Усього опубліковано</p>
                <div className="flex justify-between items-end mt-1.5">
                  <h4 className={`text-xl font-black leading-none ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>
                    {totalPublished}
                  </h4>
              ...
              <div className={`p-4 rounded-2xl border transition-all backdrop-blur-[16px] ${theme === 'light' ? 'bg-white/85 border-[#E5E7EB] shadow-sm' : 'bg-[#1c2541]/45 border-white/10 shadow-md'}`}>
                <p className="text-[10px] uppercase font-black text-gray-455 tracking-wider">Всього витрачено</p>
                <div className="flex justify-between items-end mt-1.5">
                  <h4 className={`text-xl font-black leading-none ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>
              ...
              <div className={`p-4 rounded-2xl border transition-all backdrop-blur-[16px] ${theme === 'light' ? 'bg-white/85 border-[#E5E7EB] shadow-sm' : 'bg-[#1c2541]/45 border-white/10 shadow-md'}`}>
                <p className="text-[10px] uppercase font-black text-gray-460 tracking-wider">Заброньовано зміни</p>
                <div className="flex justify-between items-end mt-1.5">
                  <h4 className={`text-xl font-black leading-none ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>
                    {activeShifts}
                  </h4>
              ...
              <div className={`p-4 rounded-2xl border transition-all backdrop-blur-[16px] ${theme === 'light' ? 'bg-white/85 border-[#E5E7EB] shadow-sm' : 'bg-[#1c2541]/45 border-white/10 shadow-md'}`}>
                <p className="text-[10px] uppercase font-black text-gray-465 tracking-wider">Суперечки (Арбітраж)</p>
                <div className="flex justify-between items-end mt-1.5">
                  <h4 className={`text-xl font-black leading-none ${disputedShifts > 0 ? 'text-red-500 animate-pulse' : theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>
                    {disputedShifts}
                  </h4>
            ...
            <div className={`rounded-3xl p-5 border transition-all backdrop-blur-[16px] ${theme === 'light' ? 'bg-white/85 border-[#E5E7EB] shadow-sm' : 'bg-[#1c2541]/45 border-white/10 shadow-md'
              ...
              <div className="flex justify-between items-center mb-3">
                <div>
                  <h4 className={`text-xs font-black uppercase tracking-wider ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>Покриття змін</h4>
              ...
              <div className="w-full h-2.5 bg-gray-250/20 rounded-full overflow-hidden flex">
                <div
            ...
            <div className={`rounded-3xl p-5 border transition-all backdrop-blur-[16px] ${theme === 'light' ? 'bg-white/85 border-[#E5E7EB] shadow-sm' : 'bg-[#1c2541]/45 border-white/10 shadow-md'
              ...
              <h4 className={`text-xs font-black uppercase tracking-wider mb-4 ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between text-[11px] font-bold">
                      <span className={theme === 'light' ? 'text-[#001B3D]' : 'text-white'}>Підбір кандидатів (ШІ)</span>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between text-[11px] font-bold">
                      <span className={theme === 'light' ? 'text-[#001B3D]' : 'text-white'}>Перегляд контактів та резюме</span>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between text-[11px] font-bold">
                      <span className={theme === 'light' ? 'text-[#001B3D]' : 'text-white'}>Бронювання та Дія.Підпис</span>
            ...
            <div className={`p-4 rounded-3xl border transition-all ${theme === 'light' ? 'bg-orange-50/50 border-orange-200 text-[#5b4039]' : 'bg-[#1c2541]/25 border-orange-500/10 text-gray-300'}`}>
        ...
        {b2bTab === 'shifts' && (
          <div className="p-4 space-y-4 text-left animate-fade-in">
            ...
            <div className={`p-1 rounded-xl flex gap-1 ${theme === 'light' ? 'bg-[#ede8e4]' : 'bg-[#121829]/65'}`}>
            ...
            <div className="space-y-3">
              {filteredShiftsList.length === 0 ? (
                <div className={`p-8 rounded-2xl border text-center ${theme === 'light' ? 'bg-white border-[#E5E7EB]' : 'bg-[#1c2541]/30 border-white/5'}`}>
                ...
                filteredShiftsList.map((shift) => (
                  <div
                    key={shift.id}
                    className={`rounded-2xl p-4 border transition-all ${theme === 'light'
                  ...
                  >
                    <div className="flex justify-between items-start mb-2.5">
                      <div>
                        ...
                        <h4 className={`text-sm font-black mt-1 ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>
                          {shift.role}
                        </h4>
                    ...
                    <div className="flex flex-col gap-2">
                      {shift.status === 'booked' && (
                        <div className="flex gap-2">
                          <button
                            ...
                            className="flex-1 bg-[#001B3D] text-white py-2 rounded-xl text-[10px] font-black uppercase tracking-wider flex items-center justify-center gap-1 transition-all active:scale-95 border border-white/5"
                          >
                      ...
                      {shift.status === 'disputed' && (
                        ...
                        >
                          ...
                          Відкрити Чат Спору (Арбітраж)
                        </button>
                      )}

                      {shift.status === 'open' && (
                        <div className="flex justify-between items-center text-[10px] text-gray-400 italic">
                          <span>Очікує на відгук кандидатур...</span>
                          <span className="text-[#FF5722] font-black uppercase text-[8px] border border-[#FF5722]/20 px-1.5 py-0.5 rounded">Пошук</span>
                        </div>
                      )}
                    </div>
                  </div>
          ...
          <div className="p-4 space-y-4 text-left animate-fade-in">
            ...
            <form onSubmit={handleCreateShift} className="space-y-4">
              ...
              <div className="relative role-combobox-container">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className={`flex-1 border rounded-xl px-3.5 py-2.5 text-xs font-bold outline-none ${theme === 'light'
                      ? 'bg-white border-[#E5E7EB] text-[#001B3D]'
                      : 'bg-[#121829]/50 border-[#2a3454] text-white focus:border-[#FF5722]'
                      }`}
                  />
                  ...
                  <div className={`absolute left-0 right-0 z-30 mt-1 border rounded-xl shadow-lg max-h-40 overflow-y-auto no-scrollbar ${theme === 'light' ? 'bg-white border-gray-200' : 'bg-[#121829] border-white/10'}`}>
                    {POPULAR_ROLES.filter(r => r.toLowerCase().includes(newRole.toLowerCase())).map((roleOption) => (
                      <button
                        ...
                        className={`w-full text-left px-4 py-2.5 text-xs font-bold transition-all ${theme === 'light' ? 'hover:bg-gray-100 text-[#001B3D]' : 'hover:bg-[#1c2541] text-white'}`}
                      >
                        {roleOption}
                      </button>
                    ))}
              ...
              <div>
                ...
                <p className={`text-[9px] mt-1.5 italic leading-normal ${theme === 'light' ? 'text-[#5b4039]/70' : 'text-gray-400'}`}>
                  {requiresScreening
        ...
        {b2bTab === 'wallet' && (
          <div className="p-4 space-y-4 text-left animate-fade-in">
            ...
            <div className="grid grid-cols-2 gap-3.5">
              <div className={`p-4 rounded-2xl border transition-all ${theme === 'light' ? 'bg-white border-[#E5E7EB] shadow-sm' : 'bg-[#1c2541]/45 border-white/10'}`}>
                <p className="text-[10px] uppercase font-bold text-gray-400">Доступно</p>
                <h3 className={`text-lg font-black mt-1 ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>
            ...
            <div className={`rounded-3xl p-5 border transition-all ${theme === 'light' ? 'bg-white border-[#E5E7EB] shadow-sm' : 'bg-[#1c2541]/40 border-white/5'}`}>
              <h3 className={`text-xs font-black uppercase tracking-wider mb-3 ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>
                Миттєве поповнення рахунку
              </h3>
              <div className="space-y-3.5">
                <div>
                  <label className={`block text-[10px] font-bold uppercase mb-1.5 ${theme === 'light' ? 'text-[#5b4039]' : 'text-gray-400'}`}>Оберіть або введіть суму (₴)</label>
                  <div className="flex gap-2 mb-2">
                    {['10000', '25000', '50000'].map(val => (
                      <button
                        ...
                        className={`flex-1 py-2 rounded-xl text-xs font-bold transition-all border ${depositAmountInput === val
                          ? 'bg-[#FF5722] text-white border-transparent'
                          : theme === 'light'
                            ? 'bg-gray-100 border-[#E5E7EB] text-[#001B3D]'
                ...
                <button
                  ...
                  className="w-full bg-[#FF5722] hover:bg-[#e64a19] text-white py-3.5 rounded-2xl text-xs font-black uppercase tracking-wider transition-all active:scale-95 shadow-md flex items-center justify-center gap-1.5"
                >
            ...
            <div className={`rounded-3xl p-5 border transition-all ${theme === 'light' ? 'bg-orange-50/20 border-orange-200 text-[#5b4039]' : 'bg-[#1c2541]/20 border-orange-500/10'}`}>
              <div className="flex gap-3 items-start">
                <FileText className="w-5 h-5 text-[#FF5722] shrink-0 mt-0.5" />
                <div className="space-y-1.5 flex-1">
                  <h4 className={`text-xs font-black uppercase tracking-tight ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-wider border mt-2 block transition-all active:scale-95 ${theme === 'light'
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                {transactions.length === 0 ? (
                  <div className={`p-4 rounded-xl border text-center text-[10px] text-gray-400 font-bold ${theme === 'light' ? 'bg-white border-gray-250' : 'bg-transparent border-white/5'}`}>
                  ...
                  transactions.map((tx) => (
                    <div
                      key={tx.id}
                      className={`p-3 rounded-xl border flex items-center justify-between text-xs transition-all ${theme === 'light' ? 'bg-white border-[#E5E7EB]' : 'bg-[#1c2541]/30 border-white/5'
                        }`}
                    >
                      <div className="space-y-0.5">
                        <p className={`font-bold ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>{tx.title}</p>
        ...
        {b2bTab === 'profile' && (
          <div className="p-4 space-y-5 text-left animate-fade-in">
            {/* Identity card */}
            <div className={`rounded-3xl p-5 border transition-all relative overflow-hidden flex items-center gap-4 ${theme === 'light' ? 'bg-white border-[#E5E7EB] shadow-sm' : 'bg-gradient-to-br from-[#1c2541]/85 to-[#121829]/95 border-white/10'}`}>
              ...
              <div className="flex-1 min-w-0">
                <h3 className={`text-sm font-black truncate ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>
            ...
            <div className={`p-4 rounded-2xl border transition-all ${theme === 'light' ? 'bg-white border-[#E5E7EB]' : 'bg-[#1c2541]/35 border-white/5'}`}>
              <h4 className={`text-[10px] font-black uppercase tracking-wider mb-2.5 ${theme === 'light' ? 'text-[#5b4039]' : 'text-gray-400'}`}>
                Контактна особа (Адміністратор)
              </h4>
              <div className="space-y-1.5 text-xs">
                <div className="flex justify-between">
                  <span className="text-gray-400">Ім’я менеджера:</span>
                  <span className={`font-bold ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>{userName}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Номер телефону:</span>
                  <span className={`font-bold ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>{userPhone}</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 max-h-48 overflow-y-auto no-scrollbar pr-0.5">
                {branches.map(b => (
                  <div
                    key={b.id}
                    className={`p-3 rounded-xl border flex items-center justify-between gap-3 text-xs ${theme === 'light' ? 'bg-white border-[#E5E7EB]' : 'bg-[#1c2541]/25 border-white/5'
                      }`}
                  >
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-1.5">
                        <span className={`font-bold ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>{b.name}</span>
                        {b.requiresScreening && (
              ...
              <div className={`p-4 rounded-2xl border text-xs space-y-3.5 ${theme === 'light' ? 'bg-gray-50 border-gray-200' : 'bg-[#121829]/50 border-white/5'}`}>
                <h5 className={`text-[10px] font-black uppercase tracking-wider ${theme === 'light' ? 'text-[#001B3D]' : 'text-white'}`}>
                  Додати нову філію
                </h5>
                <div className="space-y-2">
                  <input
                    ...
                    className={`w-full border rounded-xl px-3 py-2 text-xs font-bold outline-none ${theme === 'light' ? 'bg-white border-gray-250' : 'bg-[#121829]/50 border-[#2a3454] text-white'}`}
                  />
                  <input
                    type="text"
                ...
                <button
                  ...
                  className="w-full bg-[#001B3D] text-white py-2 rounded-xl text-[10px] font-black uppercase tracking-wider transition-all active:scale-95"
                >
      ...
      {/* ======================================================== */}
      <div className={`absolute bottom-0 left-0 right-0 h-[83px] border-t flex items-center justify-around px-2 z-40 transition-colors duration-300 ${theme === 'light'
        ? 'bg-white/95 border-gray-200 shadow-[0_-4px_12px_rgba(0,0,0,0.03)] text-[#001B3D]'
        ...
        <div
          ...
          className={`flex flex-col items-center justify-center w-[60px] h-[54px] rounded-[18px] relative transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer ${b2bTab === 'dashboard'
            ? 'text-[#FF5722]'
            : 'text-gray-400 hover:text-gray-200'
            }`}
        >
          {b2bTab === 'dashboard' && <div className="absolute inset-0 bg-[#FF5722]/8 rounded-[18px]"></div>}
        ...
        <div
          ...
          className={`flex flex-col items-center justify-center w-[60px] h-[54px] rounded-[18px] relative transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer ${b2bTab === 'shifts'
            ? 'text-[#FF5722]'
            : 'text-gray-400 hover:text-gray-200'
            }`}
        >
          {b2bTab === 'shifts' && <div className="absolute inset-0 bg-[#FF5722]/8 rounded-[18px]"></div>}
        ...
        <div
          ...
          className={`flex flex-col items-center justify-center w-[60px] h-[54px] rounded-[18px] relative transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer ${b2bTab === 'create'
            ? 'text-[#FF5722]'
            : 'text-gray-400 hover:text-gray-200'
            }`}
        >
          {b2bTab === 'create' && <div className="absolute inset-0 bg-[#FF5722]/8 rounded-[18px]"></div>}
        ...
        <div
          ...
          className={`flex flex-col items-center justify-center w-[60px] h-[54px] rounded-[18px] relative transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer ${b2bTab === 'wallet'
            ? 'text-[#FF5722]'
            : 'text-gray-400 hover:text-gray-200'
            }`}
        >
          {b2bTab === 'wallet' && <div className="absolute inset-0 bg-[#FF5722]/8 rounded-[18px]"></div>}
        ...
        <div
          ...
          className={`flex flex-col items-center justify-center w-[60px] h-[54px] rounded-[18px] relative transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer ${b2bTab === 'profile'
            ? 'text-[#FF5722]'
            : 'text-gray-400 hover:text-gray-200'
            }`}
        >
          {b2bTab === 'profile' && <div className="absolute inset-0 bg-[#FF5722]/8 rounded-[18px]"></div>}
