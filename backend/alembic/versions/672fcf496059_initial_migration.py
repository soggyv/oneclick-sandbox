...
def upgrade() -> None:
    ...
    # 1. Create users table first (without company_id foreign key constraint)
    ...
    # 2. Create organizations table (with coordinator_id foreign key to users.id)
    ...
    # 3. Add the foreign key constraint for company_id on the users table (using batch mode for SQLite)
